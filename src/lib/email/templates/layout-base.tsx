...
import { DOURADO, FUNDO_CABECALHO, ICONES, LOGO_URL, NAVY, type RedesSociais } from "./identidade";
...
// sociais.
//
// Fundo da página fora do cartão branco é navy escuro (pedido de Luiz — dá mais destaque ao
// e-mail do que o creme claro que tinha antes).
...
export function EmailLayout({ previewText, linkWhatsapp, redesSociais, linkDescadastro, children }: EmailLayoutProps) {
  return (
    <Html lang="pt-BR">
      ...
      <Body style={{ backgroundColor: NAVY, margin: 0, padding: "24px 0", fontFamily: "Arial, Helvetica, sans-serif" }}>
        <Container style={{ backgroundColor: "#ffffff", maxWidth: 480, borderRadius: 12, overflow: "hidden" }}>
          <Section style={{ backgroundColor: FUNDO_CABECALHO, padding: "24px 32px", textAlign: "center" }}>
            <Img src={LOGO_URL} alt="ArrudaCred" width={160} style={{ display: "block", margin: "0 auto" }} />
          </Section>
