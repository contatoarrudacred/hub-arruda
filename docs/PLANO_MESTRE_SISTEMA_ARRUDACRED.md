...
- ⬜ **Pendente de ação manual de Luiz:** rodar as migrations [`20260815150000_motor_followup.sql`](../supabase/migrations/20260815150000_motor_followup.sql) (✅ já rodada), [`20260815160000_followup_emails.sql`](../supabase/migrations/20260815160000_followup_emails.sql) (✅ já rodada) e [`20260815170000_pessoas_email_marketing.sql`](../supabase/migrations/20260815170000_pessoas_email_marketing.sql) (⬜ nova, criada junto com o e-mail de boas-vindas — ver seção abaixo) no SQL Editor do Supabase; configurar `CRON_SECRET` no Vercel quando for deployar.

### E-mail de boas-vindas ✅ construído, migration pendente (15/08/2026)
...
- ✅ **Conteúdo definido com Luiz:** voz da Malala (primeira pessoa, continuidade com o WhatsApp), curto e pessoal — saudação, bloco de confiança (nota Reclame Aqui/Google, certificado RA1000, 5.000+ clientes, contrato formal, indicação ao Prêmio Reclame Aqui 2026), um link de blog (post sobre a indicação ao prêmio: `arrudacred.com.br/empresa-confiavel-limpar-nome-arrudacred-reclame-aqui/`), CTA "CHAMAR NO WHATSAPP" (`wa.me/5513974024339`, número confirmado direto no site oficial) e rodapé com CNPJ + link de descadastro.
- ✅ **Template em React Email** (`src/lib/email/templates/boas-vindas.tsx`) — HTML de e-mail tem regras próprias (Outlook não entende CSS moderno), por isso não reaproveita Tailwind/componentes web; usa a biblioteca feita pelo próprio time da Resend, com estilos inline. Renderizado e conferido visualmente antes de integrar.
...
- ⬜ **Pendente de ação manual de Luiz:** rodar a migration [`20260815170000_pessoas_email_marketing.sql`](../supabase/migrations/20260815170000_pessoas_email_marketing.sql) — sem ela `pessoas.email_boas_vindas_enviado`/`email_marketing_opt_out` não existem e o envio falha (com erro claro, não silencioso).
