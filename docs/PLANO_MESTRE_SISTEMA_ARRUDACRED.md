...
- ⬜ **Bloco B — colaboração:** notas internas, @menção, atribuição a atendente específico, respostas prontas, atalho "usar próxima etapa do script", modal de follow-up ao sair de conversa sem resposta.
