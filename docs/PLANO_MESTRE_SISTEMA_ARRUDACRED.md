...
- 🔶 **Bloco D — refinamentos, em andamento (17/08/2026):** histórico de fotos do contato, selo de risco de esfriar (3 sinais, decisão de Luiz — construir completo, não simplificado), confirmação de leitura, roteamento de lead novo (3 modos configuráveis), configuração de rejeição de chamada.
