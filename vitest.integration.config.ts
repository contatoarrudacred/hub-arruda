...
// .env.local da config base (não usa mergeConfig porque o array `exclude` da base concatenaria
// com o novo `include`, mantendo a exclusão que a base define pra estes mesmos arquivos).
import { defineConfig } from "vitest/config";
import { carregarEnvLocal, resolveAlias } from "./vitest.config.mts";
